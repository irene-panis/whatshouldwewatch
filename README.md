...
https://whatshouldwewatch.vercel.app/
...
Overlap can be found for up to 10 users at once. Movies that appear in more than 50% of the inputted users' watchlists will be listed upon submit.
...
- **Display Movie Information:** Allow users to view movie synopsis on hover/click
